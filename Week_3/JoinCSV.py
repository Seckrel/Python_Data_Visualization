...
def test_CSV_join_efficiency(cancer_csv_file, center_csv_file):
    ...
    print("Read", len(risk_FIPS_list), "county center FIPS codes")
    ...
    print("Checked for FIPS membership using list in", end_time-start_time, "sec")
...
test_CSV_join_efficiency("./Datasets/cancer_risk_trimmed_solution.csv", "./Datasets/USA_Counties_with_FIPS_and_centers.csv")
